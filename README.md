...
1. 克隆项目
```bash
git clone https://github.com/asdfghjkl15203583235-maker/gongkao_vocab.git
cd gongkao-vocab
```
...
1. 下载/unpackage/release/apk/H56E61F21__20260503093007.apk
2. 在浏览器中打开(也可以是夸克)
3. 浏览器会提示"安装到桌面"
4. 点击安装即可将应用添加到桌面
...
- [lifang](https://github.com/asdfghjkl15203583235-maker)
- Email: 15203583235@qq.com
